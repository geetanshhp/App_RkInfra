...
public class Acp extends AppCompatActivity
{
    ...
    DatabaseReference definationP=database.getReference("Acp/Defination");
    DatabaseReference p1=database.getReference("Acp/P1");
    DatabaseReference p2=database.getReference("Acp/P2");
    DatabaseReference p3=database.getReference("Acp/P3");
    DatabaseReference p4=database.getReference("Acp/P4");
    ...
    {
        {
            ...
            StorageReference fisrt=reference.child("acpexternal.png");
            File myfile=null;
            try
            {
            ...
            StorageReference second=reference.child("acpinternal.png");
            File myfile2=null;
            try
            {
            ...
            StorageReference third=reference.child("acpinteriors.png");
            File myfile3=null;
            try {
            ...
            StorageReference four=reference.child("acpaluminium.png");
            File myfile4=null;
            try {
